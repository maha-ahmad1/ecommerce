...
export const card = ({ imageSrc, title, description, link, linkText, children,...rest }) => {
  return (
        <div className='flex' {...rest}>
          <div className="w-[20%]  bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mt-20 ml-40 h-[50%]">
